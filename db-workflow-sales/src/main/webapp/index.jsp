<html lang="en">
  <head>
    ...
    <meta name="author" content="Gerson Nunes Rosolim">
    <link rel="shortcut icon" href="http://templateninja.net/themes/clotheshop/v1.1/img/favicon.png">

    <title>Rafaela Araújo</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="clotheshop-navbar">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="index.html#">USD</a></li>
            <li><a href="index.html#">EUR</a></li>
            <li><a href="index.html#">IDR</a></li>
            <li class="divider-vertical"></li>
            <li class="dropdown">
              <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">LANGUAGE <b class="caret"></b></a>
            ...
            <li><%out.print(new java.util.Date());%></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-6">
          <div class="logo">
            <h1><a href="index.html">Rafaela<span>Araújo</span> </a></h1>
            <p>Semijoias</p>
          </div>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-6">
          <div class="account">
            <ul>
              <li id="your-account">
                <div class="hidden-xs">
                  <h4><a href="index.html#">Sua Conta</a></h4>
                  <p>Bem-Vindo, <a href="login.html">Acesse	</a></p>
                </div>
              ...
              <li>
                <div class="hidden-xs">
                  <h4><a href="cart.html">Sacola</a></h4>
<!--                   todo Implementar contagem de produtos escolhidos -->
                  <p><strong>Implementar contagem</strong></p> 
                </div>
                <div class="visible-xs">
        ...
        <div class="col-md-12">
          <div class="nav-menus">
            <ul class="nav nav-pills">
              ...
              <li><a href="index.html#">Anéis</a></li>
              <li><a href="index.html#">Brincos</a></li>
              <li><a href="index.html#">Colares e Pingentes</a></li>
              <li><a href="index.html#">Conjuntos</a></li>
              <li><a href="index.html#">Pulseiras</a></li>
<!--              <li class="dropdown">
                 <a href="index.html#" data-toggle="dropdown" class="dropdown-toggle">Brincos<b class="caret"></b></a>
                <ul class="dropdown-menu" id="menu1">
                  <li>
                    <a href="index.html#">Shirts <b class="caret"></b></a>
                    <ul class="dropdown-menu sub-menu">
                      <li><a href="index.html#">Shirts</a></li>
                      <li><a href="index.html#">T-shirts</a></li>
                      <li><a href="index.html#">Polo Shirts</a></li>
                      <li><a href="index.html#">Tanktop</a></li>
                    </ul>
                  </li>
                  <li><a href="index.html#">Jacket</a></li>
                  <li><a href="categories.html">Pants</a></li>
                  <li><a href="index.html#">Boxer</a></li>
                  <li class="divider"></li>
                  <li><a href="index.html#">SweatShirts</a></li>
                </ul>
              </li>
              <li class="dropdown">
                <a href="index.html#" data-toggle="dropdown" class="dropdown-toggle">Girl <b class="caret"></b></a>
                <ul class="dropdown-menu" id="menu1">
                  <li><a href="index.html#">Shirts</a></li>
              ...
              <li><a href="index.html#">Edition</a></li>
              <li><a href="index.html#">Authorized Dealer</a></li> -->
      ...
      <div id="home-slider" class="carousel slide" data-ride="carousel">
        ...
        <a class="left carousel-control" href="index.html#home-slider" data-slide="prev">
          <i class="fa fa-angle-left"></i>
        </a>
        <a class="right carousel-control" href="index.html#home-slider" data-slide="next">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="widget">
                ...
                <ul class="list-unstyled list-star">
                  ...
                  <li><a href="index.html#">Payment Option</a></li>
                  <li><a href="index.html#">Booking Tips</a></li>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="widget">
                ...
                <ul class="list-unstyled list-star">
                    ...
                    <li><a href="index.html#">Bali</a></li>
